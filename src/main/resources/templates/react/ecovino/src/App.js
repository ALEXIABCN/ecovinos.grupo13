...
const bodegas = [
    ...
    {name: 'Pares Baltá', logo:'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQlaOmDqvm3MCQ9_p1Qd5ZAZtcDmCoRTFW01w&usqp=CAU', ddo: 'Penedes', img: '', description: 'description', link: '', productos:bodega3},
